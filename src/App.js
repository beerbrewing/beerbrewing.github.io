          ...
          <header className="App-header">
            <p>
              ...
              <div className="Beer"><div className="BeerSnap"><a href={"mailto:kegs_maybanke@pyrmontbrewery.com"} target={"_blank"}
                    className={beerLink}>Maybanke's<br/>Dark Mild</a></div><div className="BeerDesc">Maybanke Anderson set up and operated the first kindergarten school here in Australia. An amazing achievement! This is an English Midlands dark mild similar to Banks'<br/><br/></div></div>
