      ...
      :
        ...
        :
          <header className="App-header">
            ...
            <span>
            All grain beers brewed on Miller Street<br/><br/></span>
            ...
            <br/>
               <div className="Beer" style={{backgroundImage: `url(${quarryImage})`}}><div className="BeerSnap"><a href={"mailto:kegs_maybanke@pyrmontbrewery.com?subject=Beer: Maybanke Dark Mild&body=I'd like 50L Keg (A type) / 20L Keg (A type) / 19L Corny keg (ball lock) / 330ml Cans X 24"} target={"_blank"}
                                                                 className={beerLink}><b>Maybanke</b><br/><i>Dark Mild</i><br/>3.4%<br/></a></div><div className="BeerDesc">Maybanke Anderson set up and operated the first kindergarten school here in Australia. An amazing achievement! <br/><br/>This is an English Midlands dark mild (mid-strength) similar to Banks' Dark Mild<br/><br/></div></div>
            <br/>
            ...
            <br/>
              ...
              <br/>
            <span>
                <b>The Pyrmont Brewery is <u>not</u> today in a position to sell you beer, but<br />if you live or work in Pyrmont you are quite likely to bump in to it at various local meet-ups<br />We'll let you know when that changes here and on social media<br/></b>
