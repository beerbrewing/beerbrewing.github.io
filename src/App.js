        ...
        :
          <header className="App-header">
            <p>
              ...
              <div className="Beer" style={{backgroundImage: `url(${quarryImage})`, opacity: 0.85}}><div className="BeerSnap"><a href={"mailto:kegs_halfway@pyrmontbrewery.com"} target={"_blank"}
            ...
            <br/>
               <div className="Beer" style={{backgroundImage: `url(${quarryImage})`, opacity: 0.85}}><div className="BeerSnap"><a href={"mailto:kegs_whingingpom@pyrmontbrewery.com"} target={"_blank"}
            ...
            <br/>
               <div className="Beer" style={{backgroundImage: `url(${quarryImage})`, opacity: 0.85}}><div className="BeerSnap"><a href={"mailto:kegs_maybanke@pyrmontbrewery.com"} target={"_blank"}
            ...
            <br/>
               <div className="Beer" style={{backgroundImage: `url(${quarryImage})`, opacity: 0.85}}><div className="BeerSnap"><a href={"mailto:kegs_arrogant@pyrmontbrewery.com"} target={"_blank"}
            ...
            <br/>
               <div className="Beer" style={{backgroundImage: `url(${quarryImage})`, opacity: 0.85}}><div className="BeerSnap"><a href={"mailto:kegs_quaffer@pyrmontbrewery.com"} target={"_blank"}
            ...
            <br/>
               <div className="Beer" style={{backgroundImage: `url(${quarryImage})`, opacity: 0.85}}><div className="BeerSnap"><a href={"mailto:kegs_cider@pyrmontbrewery.com"} target={"_blank"}
            ...
            <br/>
               <div className="Beer" style={{backgroundImage: `url(${quarryImage})`, opacity: 0.85}}><div className="BeerSnap"><a href={"mailto:kegs_paradise@pyrmontbrewery.com"} target={"_blank"}
            ...
            <br/>
               <div className="Beer" style={{backgroundImage: `url(${quarryImage})`, opacity: 0.85}}><div className="BeerSnap"><a href={"mailto:kegs_purgatory@pyrmontbrewery.com"} target={"_blank"}
              ...
              <br/>
               <div className="Beer" style={{backgroundImage: `url(${quarryImage})`, opacity: 0.85}}><div className="BeerSnap"><a href={"mailto:kegs_hellhole@pyrmontbrewery.com"} target={"_blank"}
              ...
              <br/>
               <div className="Beer" style={{backgroundImage: `url(${quarryImage})`, opacity: 0.85}}><div className="BeerSnap"><a href={"mailto:kegs_mybrew@pyrmontbrewery.com"} target={"_blank"}
              ...
              <span>
              Can deliver within Pyrmont area only<br/><a href={"mailto:kegs@pyrmontbrewery.com"} target={"_blank"}
          ...
          <p>
            ...
            <p>
              ...
              Pyrmont Brewery beer arrives chilled
            </p>
            <p>
